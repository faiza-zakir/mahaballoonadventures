...
let blogs = [
  ...
  //   },
  {
    ...
    banner: "",
    description: {
      en: "<p>Dubai: A dreamer’s utopia where aspirations soar high – a desert oasis that radiates luxury and cutting-edge technology in every direction...</p>",
      ar: "<p>دبي: يوتوبيا حالمة حيث تطمح الأحلام إلى التحليق عاليًا - واحة صحراوية تشع بالفخامة والتكنولوجيا المتطورة في كل اتجاه...</p>",
    },
    gallery: ["mainImg", "mainImg", "mainImg"],
    more_description: {
      en: "<p>For those who prefer luxury helicopter tours...</p>",
  ...
  //   },
  {
    ...
    banner: "",
    description: {
      en: "<p>If you think Dubai is all about beaches, shopping malls, amusement parks, and skyscrapers...</p>",
  ...
  //   },
  {
    ...
    banner: "",
    description: {
      en: "<p>Think about drifting serenely over the Arabian desert, watching the sunrise cast a golden glow over the endless dunes and clear weather!... </p>",
